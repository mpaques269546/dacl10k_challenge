...
class MultiScaleDeformableAttention(nn.Module):
    ...
    def init_weights(self) -> None:
        ...
        torch.nn.init.xavier_uniform_(self.value_proj.weight, gain=0.)
        #xavier_init(self.output_proj, distribution='uniform', bias=0.)
        torch.nn.init.xavier_uniform_(self.output_proj.weight, gain=0.)
        self._is_init = True
    ...
    def forward(self,
        ...
        """
        if torch.cuda.is_available() and value.is_cuda : #if ((IS_CUDA_AVAILABLE and value.is_cuda) or (IS_MLU_AVAILABLE and value.is_mlu)):
